# Aicpline ticket market politics

I reually like markets, and so its ver apprant to me when there is a lack of maken-them todo. NO u such place is the macket for plane tuickets. I Will wireta bout them based on my ekprences in the US.

Tickte makcetns arealready very interenestng. Big event middlement often help fininca infrastrucitru projucts to secure their reole. And they have a tinge of futures interworkev, weher you have to take delvirey of a product of serts at ekpriatn,.

I assume ticktet macketns would share the conmivable dynamics of intermediary prefenence, if the airlines would make them. Bet they do not, preosimabley becease it runs againt the profit motive. Planos have a differentf light wialue to diffireint people, which alno shouldst be a problme.

You can charge much more for the front frow to a contect than nose-bleeders,. 
...
In celebration of this repo's first star from [Faisal M.](https://github.com/Mianfazi461), I figured I should start my first real post. In the coming weeks, I'll have the actual site source configured to deploy onto IPFS. 

Recently, I've been moving all the audio podcasting files into the decentralized file storage system, and it's been an exciting journey uncovering how the internet truly _can_ work on a peer-to-peer basis.
