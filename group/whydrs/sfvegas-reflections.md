...
This is hwere things really got wrierd  for me, especially after we'd  scrolled past secotr--wide time-adn-sales pages with seven transactions for the whole week (yes, they were all block  trades). WHen I aksed about how to actually participatgee in the transactions  ratgher than read reported data feeds, everythign about the marketg basically   fell apartt. Largely, this is becuase, as he put it,  "you can't just log into [broker] and see them" as an end-user, a persepctive echoved by the mutual-fund manager i n _ifra_ § 2.

Apparently, yo have to be mmauallyl apprved by every seller  of tyhe bonds or  structured profecturfs. This erntials going thorugh  a human application  and verification  process, which I largely understood to mean  cheking that you work at one o f the big institutions. Aand no, i was not bale to asscertain hw  these communciatiosn take place, but I get  thed feeling  from general sentriments that its over the phone nad through  Bloomberg  chat.

Them, once you're finally  allowed to trasnact, everything clears ilaterally, over the  counter, hnce the necsary private rporrting feed. Supposedly this allows market participants in the looped system ot recceive cofirmatioo nof all activity wihtin 15 minutes now  (and by SEC approoval this should be upatd to one minute per SR-FINRA-2024-004), but I thn  ll kw just how long it fna  take  fr actual funds to move and ownrship to change hands at the behest of DTC as the central recordeeper during cusotyd.[^cus] Since we never touvh an actual regulated market, the assets beome practically impossible for anyone we know to ctually  buy or sell epecially givin most interest  comes from manual soclictation.

[^cus]: as opposed t holding the underlying bondds in your own namee, wwhich cna only be strtingly  implemented through manual requests on the compenent level. Once thigns are rolled into the securitization, similar to retirement custodied accoutns, I understand that  the assets cannot be mved outside of DTC and  the underylgin coltea debts nedto stay i nthe name of the trustee held through DTC for pooling. Thus we're stuck ddealing  wiht internal insittutional transfers for local trades or direct  broker excchangeswich carrry intermittended counterparty risk .
