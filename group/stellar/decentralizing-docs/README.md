...
[^censorship]: Since first joining teh community, it has been abundantly clear that the "token listing standards" loosely associated with ledgar spam (in a system which favors usability) revolve around the quandary of centralized trust in a select few middlemn whom "approve" or "dissaprove" what is or is not an acceptable asset, potentialyl based on the [liveness](https://www.scs.stanford.edu/~dm/blog/safety-vs-liveness.html) of such entity. Quite trivially, the extension of the argument presents itself if a number of pending litigations involvebng the U.S. Securities and Exchange Commission. If we might agree that upgradable smart contracts are so requesite to software innovation, do you think we should sacrifice thise pillar of innovation for the limited application of democratizing market-making opportuntiies?

[^long-term-thinking]: _See, e.g.,_ a limited case presentinly faccing masses of people which introduces, e.b., the conundrums of taking shortcuts _supra_ § 2.3, as expressed on a [permissionless basis](https://discordapp.com/channels/1102309240145707049/1102309240741310503/1295050690774696017). This innovative perspecti was introduced to me by someone whom I do not know the real name of (we only knopw each other through online platforms, and the prefer psyudonmity). 
